...
public struct TestCaseResult: Codable, CustomStringConvertible, Hashable {
    ...
    public var description: String { return "\(testCaseIdentifier) (\(duration) seconds)" }
...
extension TestCaseResult: DefaultInitializable {
    public static func defaultInit() -> TestCaseResult {
        return TestCaseResult(node: "", xcResultPath: "", suite: "", name: "", status: .passed, message: "", duration: 0.0, testCaseIDs: [], testTags: [])
    }
}
