...
public class ExecuterLogger: Logger, CustomDebugStringConvertible {
    ...
    public var description: String { return "\(address) - \(name)" }
    public var debugDescription: String { return "\(name), \(address), logs: \(logs.count)" }
...
extension ExecuterLogger: Equatable, Hashable {
    ...
    public static func == (lhs: ExecuterLogger, rhs: ExecuterLogger) -> Bool {
