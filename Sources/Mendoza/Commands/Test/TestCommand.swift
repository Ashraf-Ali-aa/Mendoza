...
class TestCommand: Command {
    ...
    let timeoutField = Argument<Int>(name: "seconds", kind: .named(short: nil, long: "timeout"), optional: true, help: "Maximum allowed idle time (in seconds) in test standard output before dispatch process is automatically terminated. Default 60 seconds")
    ...
    func run() -> Bool {
        do {
            ...
            let timeout = timeoutField.value ?? 60
