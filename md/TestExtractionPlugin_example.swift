...
struct XCTestFileParser {
    func extractTestCases(from urls: [URL], baseXCTestCaseClass: input.baseXCTestCaseClass, include _: input.include, exclude _: input.exclude) throws -> [ExtractionTestCase] {
